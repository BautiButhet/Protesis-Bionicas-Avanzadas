...
//     // Debug için sensör verilerini oku
//     if (init_result == 0) {
//       // Kütüphane fonksiyonunu kullanarak tüm verileri oku
//       if (icm42688_read_all(&imu_sensor, &sensor_data) == 0) {
//         // Ayrı değişkenlere de ata
